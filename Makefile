...
manifests: ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	@echo "Skip generating manifests since operator runtime is removed."

.PHONY: generate
generate: ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
	@echo "operator runtime removed; use standard go tools instead."
...
build-installer: ## Generate a consolidated YAML with CRDs and deployment.
	@echo "operator runtime removed; use kustomize to build observability resources instead."

##@ Deployment

.PHONY: install
install: ## Install CRDs into the K8s cluster.
	@echo "operator runtime removed; there are no CRDs to install."

.PHONY: uninstall
uninstall: ## Uninstall CRDs from the K8s cluster.
	@echo "operator runtime removed; there are no CRDs to uninstall."

.PHONY: deploy
deploy: ## Deploy controller to the K8s cluster.
	@echo "operator runtime removed; deploy is no longer applicable. Use standard remote kustomization."

.PHONY: undeploy
undeploy: ## Undeploy controller from the K8s cluster.
	@echo "operator runtime removed; undeploy is no longer applicable."
