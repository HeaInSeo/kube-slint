...
// UnmarshalText는 텍스트에서 연산자를 디코딩함.
...
// JudgeSpec은 SLI 값을 판단하기 위한 규칙을 정의함.
type JudgeSpec struct {
	Rules []Rule
}

// SLISpec은 선언적 SLI 정의임.
// v3에서는 의도적으로 작게 유지됨.
type SLISpec struct {
	ID          string
	Title       string
